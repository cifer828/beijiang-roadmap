...
const jiadengyuHotel = hotel({ id: "jiadengyu-jinmeijia", ...POINTS.jiadengyuHotel, platform: "携程", status: "已预订", room: "两笔订单 · 已知 1 间阁楼星空房，另一笔房型待补", checkIn: "10/2 14:00 后", checkOut: "10/3 14:00 前", amount: "¥1,074.34（¥550 + ¥524.34）", order: "1128149533658416 / 1128149533633452", cancel: "10/1 23:59 前免费取消，此后不可取消或修改", address: "新疆布尔津贾登峪一区一字楼 1 栋", receipts: ["/images/orders/jiadengyu-order-1128149533658416.jpg", "/images/orders/jiadengyu-order-1128149533633452.jpg"] });
...
const boleHotel = hotel({ id: "bole-ji", ...POINTS.boleHotel, platform: "华住会", status: "已预订", room: "高级大床房 2 间 · 早餐赠 2 份（限铂金会员入住）", checkIn: "10/4 14:00 后", checkOut: "10/5 16:00 前", amount: "¥670.94", cancel: "10/3 23:00 前免费取消，此后不可取消", address: "博乐青得里大街 76 号（J6-1-70-1）", receipts: ["/images/orders/bole-ji-2026-10-04.jpg"] });
...
const teksHotel = hotel({ id: "teks", ...POINTS.teksHotel, name: "全季特克斯九宫新城酒店", platform: "华住会", status: "已预订 · 已选定", room: "商务大床房 2 间 · 早餐赠 2 份（限铂金会员入住）", checkIn: "10/6 12:00 后", checkOut: "10/7 16:00 前", amount: "¥483.26", cancel: "10/5 23:00 前免费取消，此后不可取消", address: "九宫新城经六路综合商业广场 A1 栋", receipts: ["/images/orders/teks-ji-2026-10-06.jpg"] });
...
export const DAYS: TripDay[] = [
  ...
  },
  {
    id: "2026-10-04", day: 6, date: "10/4 周日", shortDate: "10/4", month: "日", dayOfMonth: "4", week: "周日", title: "布尔津长途直达博乐", route: "布尔津 → 世界魔鬼城（可途经）→ 奎屯吃晚饭 → 博乐", drive: "自驾直达约 8 小时 / 经魔鬼城约 8.5 小时", timeline: [
      ...
      { time: "晚上", title: "抵达博乐入住", detail: "全季酒店已预订，高级大床房 2 间", point: POINTS.boleHotel },
