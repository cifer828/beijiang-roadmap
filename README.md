...
- 初始账本包含当前已知的 10 笔住宿（不含阿勒泰壹号）和 1 笔租车费用，共 ¥12,839.31，付款人均为张秋晨；两家固定 50/50 后，当前最简平账为家庭 A 向家庭 B 转账 ¥6,419.65。
...
原始迁移图片和用户提供的订单截图均不修改；应用封面只使用复制到 `public/images/` 的版本，订单截图由共享账本作为独立凭证 Blob 保存。
